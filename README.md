...
**Jerry服务器是帮助前后端完全分离的工具，它可以帮助后端工程师只做后端，前端工程师只做前端。**
...
现在了解了Node.Js后，感觉Node.Js和我的这个web服务器的角色都是中间的代理服务器，从两者渲染HTML页面的方式上来看，本质还是不同的。Node.Js使用的JS进行编程式渲染，需要写代码逻辑，我的web服务器使用的FreeMarker模板引擎，直接在HTML上写表达式语法，相比较之下，我的web服务器更简单，更方便，更有利于前后端分离。而且我的web服务器更符合服务拆分的思想。

就比如世界上为什么会有了C++还要有Java、Python等编程语言一样的道理，总之一句话，不冲突 ~ 
